...
export default function ComparisonTable() {
  ...
  return (
    <section className="bg-[#0A0A0A] py-24 md:py-32 border-t border-[#1E293B] relative overflow-hidden text-white">
      ...
      <div className="max-w-6xl mx-auto px-8 relative z-10">
        ...
        <motion.div
          ...
          className="border border-[#1E293B] rounded-2xl overflow-hidden bg-[#1A1A1A]/40 backdrop-blur-md shadow-2xl"
        >
          {/* Header Row */}
          <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#1E293B] bg-[#1A1A1A]/80 font-bold text-xs uppercase tracking-wider text-slate-400">
            <div className="p-6 md:p-8">Traditional Guidance</div>
            <div className="p-6 md:p-8 border-t md:border-t-0 md:border-l border-[#1E293B] text-cyan-400">
          ...
          {rows.map((row, idx) => (
            ...
            >
              ...
              <div className="p-6 md:p-8 border-t md:border-t-0 md:border-l border-[#1E293B] flex items-start gap-4 text-slate-100 text-xs sm:text-sm bg-cyan-500/[0.02]">
                <div className="w-5 h-5 rounded-full bg-cyan-400/10 flex items-center justify-center flex-shrink-0 text-cyan-400 mt-0.5 border border-cyan-400/20 shadow-[0_0_10px_rgba(34,211,238,0.2)]">
        ...
        <motion.div
          ...
          className="mt-16 text-center bg-[#1A1A1A] border border-[#1E293B] p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 max-w-4xl mx-auto shadow-xl"
        >
          ...
          <Link
            href="/sign-up"
            className="w-full md:w-auto px-6 py-3 bg-gradient-to-r from-cyan-400 to-indigo-500 text-white text-xs font-bold rounded-full transition-all flex items-center justify-center gap-1.5 shadow-[0_0_15px_rgba(34,211,238,0.3)] hover:shadow-[0_0_25px_rgba(34,211,238,0.5)] hover:scale-[1.02] active:scale-[0.98]"
          >
