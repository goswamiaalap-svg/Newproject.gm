...
export default function FinalCTA() {
  return (
    <section className="relative py-32 overflow-hidden bg-[#111111] border-t border-[#1E293B] text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-8 text-center">
        ...
        >
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-500">more than luck.</span>
        </motion.h2>
        ...
        >
          <Link
            href="/sign-up"
            className="group relative inline-flex items-center gap-2 px-12 h-14 bg-gradient-to-r from-cyan-400 to-indigo-500 text-white font-display font-bold text-sm rounded-full shadow-[0_0_30px_rgba(34,211,238,0.3)] hover:shadow-[0_0_40px_rgba(34,211,238,0.5)] hover:scale-[1.03] active:scale-[0.98] transition-all duration-300 overflow-hidden"
          >
