...
export default function Testimonials() {
  ...
  return (
    <section className="bg-[#0A0A0A] py-24 md:py-32 border-b border-[#222222] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {testimonials.map((t, idx) => (
            <motion.div
              ...
              className="bg-[#1A1A1A] border border-[#222222] p-8 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all flex flex-col justify-between"
            >
              <div className="space-y-2">
                {/* Large quote icon */}
                <span className="text-cyan-400 font-serif text-5xl leading-none block select-none -mb-2">“</span>
                <p className="font-sans font-medium text-xs sm:text-sm text-gray-300 leading-relaxed italic">
                  {t.quote}
                </p>
              </div>
              <div className="pt-6 mt-6 border-t border-[#222222]">
                ...
                <span className="text-[#A0A0A0] text-[10px] sm:text-xs font-sans font-medium mt-0.5 block">
                  {t.role}
                </span>
              </div>
            </motion.div>
