      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-16">
          <motion.span
            ...
            className="text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full border bg-gray-50 border-gray-200 shadow-sm text-gray-500 inline-block mb-4"
          >
            Got Questions?
          </motion.span>
          <motion.h2
            ...
            className="font-display font-extrabold text-3xl md:text-5xl text-[#111111] tracking-tight"
          >
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  isOpen ? "bg-blue-50 border-[#3B82F6] shadow-sm" : "bg-white border-gray-200 shadow-sm hover:border-gray-300"
                )}
              >
                <button
                ...
                >
                  <span className="font-display font-bold text-[#111111] pr-4">{faq.question}</span>
                  <div className={cn(
                    "w-8 h-8 rounded-full flex items-center justify-center transition-transform duration-300 shrink-0",
                    isOpen ? "bg-[#3B82F6] text-white rotate-180" : "bg-gray-50 border border-gray-200 text-gray-500"
                  )}>
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="px-6 pb-6 pt-2 text-gray-600 font-sans text-sm leading-relaxed border-t border-gray-100 mx-6 mt-2">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
