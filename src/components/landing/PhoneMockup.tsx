...
function FloatingCard({
  ...
  return (
    <animated.div
      ...
      className={cn(
        'absolute bg-bg-card rounded-card p-4 shadow-medium border border-border-default z-20 max-w-[200px]',
        className
      )}
    >
      {children}
...
export default function PhoneMockup() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-32 bg-bg-base flex flex-col items-center overflow-hidden"
    >
      {/* Title Header */}
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between pb-1 border-b border-border-default">
                      ...
                      <span className="w-5 h-5 rounded-full bg-sage text-white flex items-center justify-center text-[8px] font-bold">PS</span>
                    </div>
                    ...
                    <div className="p-3 bg-white border border-border-default rounded-card shadow-soft space-y-2">
                      ...
                      <div className="w-full h-1 bg-bg-subtle rounded-full overflow-hidden">
                        <div className="h-full bg-sage w-[42%]" />
                      </div>
                    </div>
              ...
              {activeState === 1 && (
                ...
                >
                  ...
                  <button className="w-full py-2 bg-sage text-white rounded-btn text-[8px] font-bold">
                    Re-upload Resume
                  </button>
                </motion.div>
              )}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative pl-4 border-l border-slate-200 ml-1.5 space-y-3 mt-4 text-[8px]">
                      <div className="relative">
                        <div className="absolute -left-[20px] top-0.5 w-2.5 h-2.5 rounded-full bg-sage border border-bg-card" />
                      ...
                      <div className="relative">
                        <div className="absolute -left-[20px] top-0.5 w-2.5 h-2.5 rounded-full bg-slate-200 border border-bg-card" />
