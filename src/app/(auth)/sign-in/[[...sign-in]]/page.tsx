      ...
      <SignIn
        ...
        appearance={{
          elements: {
            ...
            // Inputs
            formFieldInput:
              'w-full px-4 py-3 bg-white border border-border-default rounded-btn text-sm focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6]/50 text-text-primary transition-colors',
